...
vipro = LINETCR.LINE()
#vipro.login(qr=True)
vipro.login(token='Ergb1ayWs7wftM9LXpYb.VKQ9Jq2o+6hoVXBJ0l/fgW.nBDXMYFOsT81oF2DOS38lTfdNZD+ahtD1bZ0yzbdpEE=')
vipro.loginResult()
...
╚═════════════════════════
"""
vip="ube4abd8d0d8effa1cebf16e3d0bf851b'
...
Bots=[mid]
Creator=["ube4abd8d0d8effa1cebf16e3d0bf851b"]
admin=["ube4abd8d0d8effa1cebf16e3d0bf851b"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By : Vipro\nContact Me : 👉 line.me/ti/p/~punyacerita2",    
    "commentOn":True,
    "commentBlack":{},
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention2"] == True:          
                    contact = vipro.getContact(msg.from_)
                    cName = contact.displayName
                    balas = ["Sekali lagi nge tag gw sumpahin jomblo seumur hidup!","Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja","Woii " + cName + " Jangan Ngetag, Setann"]
                    ret_ = random.choice(balas)
                    name = re.findall(r'@(\w+)', msg.text)
                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                    mentionees = mention['MENTIONEES']
